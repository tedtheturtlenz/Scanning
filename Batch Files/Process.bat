...
set OUTPUT_FOLDER="D:\Bonsai\RC_Ouputs\Scan_and_Segment"
set ModelName=Bonsai_Tree
set Model=%OUTPUT_FOLDER%\Bonsai_Tree.xyz
set Mesh_Model=%OUTPUT_FOLDER%\Bonsai_tree.obj
set Project=%OUTPUT_FOLDER%\Bonsai_Tree.rcproj
...
%RC_PATH% -addFolder %INPUT_FOLDER% ^
    ...
    -scaleReconstructionRegion 1.1 1.1 1 center factor ^
